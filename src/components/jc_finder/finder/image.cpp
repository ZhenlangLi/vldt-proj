...
#if TEST_MODE
    saveImage(bitmap, "/Users/phantef/Desktop/test/fin/bitmap.png");
    saveImage(ch[0], "/Users/phantef/Desktop/test/fin/ch_r.png");
    saveImage(ch[1], "/Users/phantef/Desktop/test/fin/ch_g.png");
    saveImage(ch[2], "/Users/phantef/Desktop/test/fin/ch_b.png");
    
    J_Found_Symbol* found = detectMaster(bitmap, ch);
    saveImage(found->sampled_img, "/Users/phantef/Desktop/test/fin/sampled_fin.png");
    free(bitmap);
