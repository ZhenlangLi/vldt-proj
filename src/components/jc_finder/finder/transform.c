...
// adapted from the original JABCode Encoding/Decoding Library,
// original work --
 ...
 * @return the transformation matrix
*/
J_Perspective_Transform* getPerspectiveTransform(POINT p0,
												   POINT p1,
												   POINT p2,
												   POINT p3,
												   Vector2D side_size)
...
*/
void warpPoints(J_Perspective_Transform* pt, POINT* points, Int32 length)
{
